...
import lms.gui.dialog.au.JDialogGenreAUD;
 ...
 * @author admin
 */
public class JDialogGenre extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogGenre(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Book Genre List");
        ...
        setSize(new java.awt.Dimension(923, 511));
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogGenreAUD u = new JDialogGenreAUD(mainMenu, true, "Add");
        u.setTitle("Add Genre");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogGenreAUD u = new JDialogGenreAUD(mainMenu, true, "Update", this.genre);
        u.setTitle("Update Genre");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogGenreAUD u = new JDialogGenreAUD(mainMenu, true, this.genre, "Delete");
        u.setTitle("Delete Genre");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    public void setTable() {
        try {
            ...
            ArrayList v1 = new QueryLMS().selectGenre();
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object typeIdl = jTable1.getValueAt(row, 1);
                        Object typel = jTable1.getValueAt(row, 2);
                        Object genrel = jTable1.getValueAt(row, 3);
                        Object descriptionl = jTable1.getValueAt(row, 4);

                        genre.setId(Integer.parseInt(idl.toString()));
                        type.setId(Integer.parseInt(typeIdl.toString()));
                        type.setType(typel.toString());
                        genre.setType(type);
                        genre.setGenre(genrel.toString());
                        genre.setDescription(descriptionl.toString());
                        jButtonUpdate.setEnabled(true);
                        jButtonDelete.setEnabled(true);
