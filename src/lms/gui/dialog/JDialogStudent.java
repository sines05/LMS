...
import lms.gui.dialog.au.JDialogStudentAU;
...
public class JDialogStudent extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogStudent(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogStudentAU u = new JDialogStudentAU(mainMenu, true, "Add");
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        lms.gui.dialog.au.JDialogStudentAU u = new lms.gui.dialog.au.JDialogStudentAU(mainMenu, true, "Update", this.student);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        lms.gui.dialog.au.JDialogStudentAU u = new lms.gui.dialog.au.JDialogStudentAU(mainMenu, true, this.student, "Delete");
    ...
    private void jButtonAddBarcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddBarcodeActionPerformed
        JDialogStudentAddBarcode addBarcode = new JDialogStudentAddBarcode(mainMenu, true, student);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        student.setId(Integer.parseInt(idl));
                        course.setId(Integer.parseInt(courseIdl));
                        student.setFirstname(firstnamel);
                        student.setMiddlename(middlenamel);
                        student.setLastname(lastnamel);
                        course.setAcronym(coursel);
                        student.setCourse(course);
                        student.setGender(genderl);
                        student.setEmail(emaill);
                        student.setMobileNo(mobileNol);
                        student.setDateOfBirth(dobl);
                        student.setDobf(dobFl);
                        student.setAddress(addressl);
                        student.setGuardian(guardianl);
