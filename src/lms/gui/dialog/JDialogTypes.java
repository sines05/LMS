 ...
 * @author admin
 */
public class JDialogTypes extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogTypes(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Book Type List");
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogTypeAUD u = new JDialogTypeAUD(mainMenu, true, "Add");
        u.setTitle("Add Type");
        u.setVisible(true);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogTypeAUD u = new JDialogTypeAUD(mainMenu, true, "Update", this.type);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogTypeAUD u = new JDialogTypeAUD(mainMenu, true, this.type, "Delete");
    ...
    public void setTable() {
        try {
            ...
            ArrayList v1 = new QueryLMS().selectType();
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        type.setType(categoryl.toString());
                        type.setDescription(descriprionl.toString());
