 ...
 * @author Aldrin
 */
public class JDialogConfirmBorrowBook extends javax.swing.JDialog {
     ...
     */
    public JDialogConfirmBorrowBook(lms.gui.JFrameMainSLM parent, boolean modal, lms.model.Student student, lms.model.Book book) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 310, 120, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int res = JOptionPane.showConfirmDialog(rootPane, "Click yes if you want to continue?", "Borrow Confirmation", JOptionPane.YES_NO_OPTION);
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            int res = JOptionPane.showConfirmDialog(rootPane, "Click yes if you want to continue?", "Borrow Book Confirmation", JOptionPane.YES_NO_OPTION);
            if (res == JOptionPane.YES_OPTION) {
                bookBorrow.setStudent(student);
                bookBorrow.setBook(book);
                query.addBookBorrowed(bookBorrow);
