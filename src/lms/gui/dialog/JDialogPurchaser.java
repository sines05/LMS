...
import lms.gui.dialog.au.JDialogPurchaserAUD;

/**
 *
 * @author admin
 */
public class JDialogPurchaser extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogPurchaser(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(350, 72));
        ...
        setSize(new java.awt.Dimension(853, 476));
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogPurchaserAUD u = new JDialogPurchaserAUD(mainMenu, true, "Add");
        u.setTitle("Add Purchaser");
        u.setVisible(true);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        lms.gui.dialog.au.JDialogPurchaserAUD u = new lms.gui.dialog.au.JDialogPurchaserAUD(mainMenu, true, "Update", this.purchaser);
        u.setTitle("Update Purchaser");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        lms.gui.dialog.au.JDialogPurchaserAUD u = new lms.gui.dialog.au.JDialogPurchaserAUD(mainMenu, true, this.purchaser, "Delete");
        u.setTitle("Delete Purchaser");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    public void setTable() {
        try {
            ...
            colname.add("Purchaser");
            colname.add("Mobile No");
            colname.add("Address");
            colname.add("Email");

            ArrayList v1 = new lms.util.QueryLMS().selectPurchaser();
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object mobileNol = jTable1.getValueAt(row, 5);
                        Object addressl = jTable1.getValueAt(row, 6);
                        Object emaill = jTable1.getValueAt(row, 7);

                        purchaser.setId(Integer.parseInt(idl.toString()));
                        purchaser.setFirstname(firsnamel.toString());
                        purchaser.setMiddlename(middlenamel.toString());
                        purchaser.setLastname(lastnamel.toString());
                        purchaser.setMobileNo(mobileNol.toString());
                        purchaser.setAddress(addressl.toString());
                        purchaser.setEmail(emaill.toString());
