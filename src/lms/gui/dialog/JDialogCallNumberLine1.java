...
import lms.gui.dialog.au.JDialogCallNumberLineAUD;
 ...
 * @author admin
 */
public class JDialogCallNumberLine1 extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogCallNumberLine1(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Book Call Number Line 1 List");
        ...
        setSize(new java.awt.Dimension(676, 511));
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogCallNumberLineAUD u = new JDialogCallNumberLineAUD(mainMenu, true, "Add");
        u.setTitle("Add Call Number");
        u.setVisible(true);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogCallNumberLineAUD u = new JDialogCallNumberLineAUD(mainMenu, true, "Update", this.callNumberLine1);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogCallNumberLineAUD u = new JDialogCallNumberLineAUD(mainMenu, true, this.callNumberLine1, "Delete");
        u.setTitle("Delete Type");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    public void setTable() {
        try {
            ...
            ArrayList v1 = new QueryLMS().selectCallNumberLine1();
            ...
            column[2].setPreferredWidth(620);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object letterl = jTable1.getValueAt(row, 1);
                        Object descriprionl = jTable1.getValueAt(row, 2);
                        callNumberLine1.setId(Integer.parseInt(idl.toString()));
                        callNumberLine1.setLetters(letterl.toString());
                        callNumberLine1.setDescription(descriprionl.toString());
