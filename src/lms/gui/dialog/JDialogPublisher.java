...
import lms.gui.dialog.au.JDialogTypeAUD;
import lms.gui.dialog.au.JDialogPublisherAUD;
 ...
 * @author admin
 */
public class JDialogPublisher extends javax.swing.JDialog implements MouseListener {

    private JFrameMainSLM mainMenu;
    private lms.model.Publisher publisher = new Publisher();

    /**
     * Creates new form JDialogCategory
     */
    public JDialogPublisher(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Book Publisher List");
        ...
        setSize(new java.awt.Dimension(877, 538));
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogPublisherAUD u = new JDialogPublisherAUD(mainMenu, true, "Add");
        u.setTitle("Add Publisher");
        u.setVisible(true);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        lms.gui.dialog.au.JDialogPublisherAUD u = new lms.gui.dialog.au.JDialogPublisherAUD(mainMenu, true, "Update", this.publisher);
        u.setTitle("Update Publisher");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        lms.gui.dialog.au.JDialogPublisherAUD u = new lms.gui.dialog.au.JDialogPublisherAUD(mainMenu, true, this.publisher, "Delete");
        u.setTitle("Delete Publisher");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    public void setTable() {
        try {
            ...
            ArrayList v1 = new QueryLMS().selectPublisher();
            ...
            column[2].setPreferredWidth(600);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object publisherl = jTable1.getValueAt(row, 1);
                        Object addressl = jTable1.getValueAt(row, 2);
                        publisher.setId(Integer.parseInt(idl.toString()));
                        publisher.setName(publisherl.toString());
                        publisher.setAddress(addressl.toString());
