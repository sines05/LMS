...
public class JDialogFacultyAU extends javax.swing.JDialog {
     ...
     */
    public JDialogFacultyAU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public JDialogFacultyAU(lms.gui.JFrameMainSLM parent, boolean modal, String evt) {
        super(parent, modal);
    ...
    public JDialogFacultyAU(lms.gui.JFrameMainSLM parent, boolean modal, String evt, Faculty student) {
        super(parent, modal);
        this.mainMenu = parent;
    ...
    public JDialogFacultyAU(lms.gui.JFrameMainSLM parent, boolean modal, Faculty student, String evt) {
        super(parent, modal);
        this.mainMenu = parent;
        this.student = student;
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 84, 130, -1));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 114, 100, -1));

        jTextFieldEmail.setFont(new java.awt.Font("Courier New", 0, 14)); // NOI18N
        getContentPane().add(jTextFieldEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 84, 270, -1));
        ...
        getContentPane().add(jTextFieldAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 128, 410, -1));
...
//          if (jComboBoxCourse.getSelectedItem() == "Select Type") {
//            JOptionPane.showMessageDialog(mainMenu, "Please select course of student.", "Please try again!!", JOptionPane.WARNING_MESSAGE);
//            return;
//        }
//
//        ComboBoxList unitIdl = (ComboBoxList) this.jComboBoxCourse.getSelectedItem();
//        course.setId(Integer.parseInt(unitIdl.getId()));
...
//                        new QueryLMS().deleteStudent(student);
    ...
    private void displayPicture() {
        try {
//            Blob blobImage = (Blob) query.selectedPicture(student);
