 ...
 * @author Aldrin
 */
public class JDialogTypeAUD extends javax.swing.JDialog {
     ...
     */
    public JDialogTypeAUD(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
        this.mainMenu = parent;
        initComponents();
    }

    public JDialogTypeAUD(lms.gui.JFrameMainSLM parent, boolean modal, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
    ...
    public JDialogTypeAUD(lms.gui.JFrameMainSLM parent, boolean modal, String evtl, lms.model.Type category) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
        this.type = category;
        ...
        jTextFieldCategory.setText(this.type.getType());
        jTextAreaDescription.setText(this.type.getDescription());

    }

    public JDialogTypeAUD(lms.gui.JFrameMainSLM parent, boolean modal, lms.model.Type unit, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
        this.type = unit;
        ...
        jTextFieldCategory.setText(unit.getType());
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTextFieldCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 35, 290, -1));

        jTextAreaDescription.setColumns(20);
        jTextAreaDescription.setRows(5);
        jScrollPane1.setViewportView(jTextAreaDescription);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 85, 290, 240));
        ...
        setSize(new java.awt.Dimension(331, 447));
            ...
            switch (this.evt) {
                case "Add":
                    int reply = JOptionPane.showConfirmDialog(this,
                            "Are you sure  to save " + jTextFieldCategory.getText() + "   " + jTextAreaDescription.getText() + " ?",
                            "Confirmation - Exit", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
                    if (reply == JOptionPane.YES_OPTION) {
                        type.setType(jTextFieldCategory.getText());
                        type.setDescription(jTextAreaDescription.getText());
                        new QueryLMS().addType(type);
