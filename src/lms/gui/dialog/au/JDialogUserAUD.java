...
public class JDialogUserAUD extends javax.swing.JDialog {
     ...
     */
    public JDialogUserAUD(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    public JDialogUserAUD(lms.gui.JFrameMainSLM parent, boolean modal, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
    ...
    public JDialogUserAUD(lms.gui.JFrameMainSLM parent, boolean modal, String evtl, lms.model.User user) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
    ...
    public JDialogUserAUD(lms.gui.JFrameMainSLM parent, boolean modal, lms.model.User user, String evtl) {
        super(parent, modal);
        initComponents();
        this.evt = evtl;
    ...
    private void initComponents() {
        ...
        jPanel5.add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(267, 10, 100, 36));
        ...
        jPanel7.setPreferredSize(new java.awt.Dimension(15, 100));
                ...
                case "Add":
                    if (pictureFile == null) {
                        ...
                        if (reply == JOptionPane.YES_OPTION) {
                            setPhoto(new File(System.getProperty("user.dir") + "\\src\\lms\\images\\no photo.jpg"));
                            ...
                            new QueryLMS().addUser(user, getPhoto());
                        }
                    } else {
                        int reply = JOptionPane.showConfirmDialog(this,
                                ...
                                "Confirmation - Exit", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
                        if (reply == JOptionPane.YES_OPTION) {
                            setPhoto(new File(System.getProperty("user.dir") + "\\src\\lms\\images\\model.jpg"));
                            user.setFirstname(jTextFieldFirstname.getText());
                            user.setMiddlename(jTextFieldMiddlename.getText());
                            user.setLastname(jTextFieldLastname.getText());
                            user.setMobileNo(jTextFieldMobile.getText());
                ...
                case "Update":
                    if (pictureFile == null) {
                        ...
                        if (reply == JOptionPane.YES_OPTION) {
                            ...
                            user.setUsername(jTextFieldUsername.getText());
                            user.setPassword(jPasswordFieldPassword.getText());
                            new QueryLMS().updateUser(user, getPhoto(), user.getId(), false);
                        }
                    } else {
                        int reply = JOptionPane.showConfirmDialog(this,
                                "Are you sure  to update " + jTextFieldFirstname.getText() + "   " + jTextFieldLastname.getText() + " ?",
                        ...
                        if (reply == JOptionPane.YES_OPTION) {
                            ...
                            user.setUsername(jTextFieldUsername.getText());
                            user.setPassword(jPasswordFieldPassword.getText());
//                            user.setActive(jCheckBoxActive.isSelected());
                            new QueryLMS().updateUser(user, getPhoto(), user.getId(), true);
                        }
                ...
                case "Delete":
                    ...
                    if (response == JOptionPane.YES_OPTION) {
                        new QueryLMS().deleteUser(user.getId());
    ...
    private void displayPicture() {
        try {
            ...
            Blob blobImage = (Blob) query.selectUserPicture(user.getId());
