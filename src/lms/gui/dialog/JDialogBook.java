 ...
 * @author admin
 */
public class JDialogBook extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogBook(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(500, 72));
        ...
        jButtonDelete1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jButtonDelete1.setMnemonic('D');
        jButtonDelete1.setText("View");
        jButtonDelete1.setPreferredSize(new java.awt.Dimension(100, 30));
        jButtonDelete1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonDelete1ActionPerformed(evt);
            }
        });
        jPanel6.add(jButtonDelete1);
        ...
        setSize(new java.awt.Dimension(1013, 566));
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        lms.gui.dialog.JDialogRecievedNewBooks u = new lms.gui.dialog.JDialogRecievedNewBooks(mainMenu, true, "Add");
        u.setTitle("Add Category");
        u.setVisible(true);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        lms.gui.dialog.JDialogRecievedNewBooks u = new lms.gui.dialog.JDialogRecievedNewBooks(mainMenu, true, "Update", this.book);
        u.setTitle("Update Category");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        lms.gui.dialog.JDialogRecievedNewBooks u = new lms.gui.dialog.JDialogRecievedNewBooks(mainMenu, true, this.book, "Delete");
        u.setTitle("Delete Category");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
...
//            ArrayList v1 = new QueryUtil().selectCategory();
...
//                        book.setCategory(categoryl.toString());
//                        book.setDescription(descriprionl.toString());
