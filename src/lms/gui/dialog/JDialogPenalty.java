...
import lms.gui.dialog.au.JDialogPenaltyAUD;
 ...
 * @author Aldrin
 */
public class JDialogPenalty extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogPenalty(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Penalty History");
        ...
        setSize(new java.awt.Dimension(903, 589));
...
//        }
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogPenaltyAUD u = new JDialogPenaltyAUD(mainMenu, true, "Add");
        u.setTitle("Add Penalty");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogPenaltyAUD u = new JDialogPenaltyAUD(mainMenu, true, "Update", this.penalty);
        u.setTitle("Update Penalty");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogPenaltyAUD u = new JDialogPenaltyAUD(mainMenu, true, this.penalty, "Delete");
        u.setTitle("Delete Penalty");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    public void setTable() {
        try {
            ...
            colname.add("RateF");//1
            colname.add("Rate");//2        
            colname.add("<html><center>Days<br><p style=\" color: red;padding-top: 0px;\">Borrowable</p></center></html>");
            colname.add("Active");//4 boolean
            colname.add("datef");//5
            colname.add("Date");//6
            colname.add("User");//7

            ArrayList v1 = new QueryLMS().selectPenalty();
            ...
            column[6].setPreferredWidth(150);
            column[7] = jTable1.getColumnModel().getColumn(7);
            column[7].setPreferredWidth(150);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object ratel = jTable1.getValueAt(row, 1);
                        Object dayToBorrowl = jTable1.getValueAt(row, 3);
                        Boolean isActivel = Boolean.parseBoolean(jTable1.getValueAt(row, 4).toString());
                        penalty.setId(Integer.parseInt(idl.toString()));
                        penalty.setRate(Float.parseFloat(ratel.toString()));
                        penalty.setDaysToBorrow(Integer.parseInt(dayToBorrowl.toString()));
                        penalty.setActive(isActivel);
