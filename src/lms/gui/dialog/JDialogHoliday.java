...
import lms.gui.dialog.au.JDialogHolidayAUD;
import lms.model.Holiday;
 ...
 * @author Aldrin
 */
public class JDialogHoliday extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogHoliday(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        }
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        JDialogHolidayAUD u = new JDialogHolidayAUD(mainMenu, true, "Add");
        u.setTitle("Add Holiday");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogHolidayAUD u = new JDialogHolidayAUD(mainMenu, true, "Update", this.holiday);
        u.setTitle("Update Holiday");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogHolidayAUD u = new JDialogHolidayAUD(mainMenu, true, this.holiday, "Delete");
        u.setTitle("Delete Holiday");
        u.setVisible(true);
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
        setTable();
    ...
    public void setTable() {
        try {
            ...
            ArrayList v1 = new QueryLMS().selectHoliday();
            ...
            TableColumn hidden1 = jTable1.getColumnModel().getColumn(2);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object holidayl = jTable1.getValueAt(row, 1);
                        Object datel = jTable1.getValueAt(row, 2);
                        holiday.setId(Integer.parseInt(idl.toString()));
                        holiday.setHoliday(holidayl.toString());
                        holiday.setDate(datel.toString());
