...
import lms.gui.dialog.au.JDialogUserAUD;
...
public class JDialogUser extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public JDialogUser(lms.gui.JFrameMainSLM parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setTable() {
        try {
            ...
            colname.add("Password");//8

            ArrayList v1 = new QueryLMS().selectUser();
            ...
            column[0] = jTable1.getColumnModel().getColumn(1);
            column[0].setPreferredWidth(200);
            column[0] = jTable1.getColumnModel().getColumn(5);
            column[0].setPreferredWidth(200);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        Object firsnamel = jTable1.getValueAt(row, 2);
                        Object middelnamel = jTable1.getValueAt(row, 3);
                        Object lastnamel = jTable1.getValueAt(row, 4);
                        Object emaill = jTable1.getValueAt(row, 5);
                        Object mobilel = jTable1.getValueAt(row, 6);
                        Object companyl = jTable1.getValueAt(row, 7);
                        Object companyContactl = jTable1.getValueAt(row, 8);
                        user.setId(Integer.parseInt(idl.toString()));
                        user.setFirstname(firsnamel.toString());
                        user.setMiddlename(middelnamel.toString());
                        user.setLastname(lastnamel.toString());
                        user.setMobileNo(mobilel.toString());
                        user.setEmail(emaill.toString());
                        user.setUsername(companyl.toString());
                        user.setPassword(companyContactl.toString());
