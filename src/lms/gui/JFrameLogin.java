...
public class JFrameLogin extends javax.swing.JFrame {
    ...
    public JFrameLogin() {
        ...
        Image icon = Toolkit.getDefaultToolkit().getImage(System.getProperty("user.dir") + "/src/lms/images/changepassword16.png");
        setIconImage(icon);
        initComponents();
...
//        
    ...
    private void jLabel2FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jLabel2FocusLost
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aldrinpos/images/eye slash.png")));
...
//        setVisible(true);
    ...
    private void accessLogin() {
        ...
        if (new QueryLMS().loginUser(jTextFieldUsername.getText(), jPasswordFieldPassword.getText()) == true) {
            JFrameMainSLM m = new JFrameMainSLM();
            this.dispose();
            m.setVisible(true);
